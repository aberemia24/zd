...
describe('Transaction model', () => {
    describe('runtime validation cu TransactionSchema (zod)', () => {
        ...
        it('acceptă o tranzacție validă', () => {
            expect(() => transaction_schema_1.TransactionSchema.parse(validTransaction)).not.toThrow();
        });
        it('respinge tranzacție cu type invalid', () => {
            expect(() => transaction_schema_1.TransactionSchema.parse({ ...validTransaction, type: 'invalid' })).toThrow();
        });
        it('respinge tranzacție fără câmpuri obligatorii', () => {
            expect(() => transaction_schema_1.TransactionSchema.parse({})).toThrow();
            expect(() => transaction_schema_1.TransactionSchema.parse({ id: 'x' })).toThrow();
        });
        it('respinge recurrence invalid', () => {
            expect(() => transaction_schema_1.TransactionSchema.parse({ ...validTransaction, recurrence: 'biweekly' })).toThrow();
        });
    });
    ...
    it('nu permite valori invalide pentru recurrence', () => {
        // @ts-expect-error
        const t = { ...baseTransaction, type: 'expense', recurrence: 'biweekly' };
...
describe('categories config', () => {
    ...
    it('are subcategoriile corecte pentru venituri', () => {
        expect(categories.income).toEqual(expect.arrayContaining([
    ...
    it('are subcategoriile corecte pentru economii', () => {
        expect(categories.savings).toEqual(expect.arrayContaining([
    ...
    it('are chei de localizare pentru fiecare subcategorie de cheltuieli', () => {
        Object.values(categories.expenses).forEach((expenseGroup) => {
            expenseGroup.forEach((subcategory) => {
    ...
    it('are subcategoriile corecte pentru cheltuieli.appearance', () => {
        expect(categories.expenses.appearance).toEqual(expect.arrayContaining([
    ...
    it('are subcategoriile corecte pentru cheltuieli.education', () => {
        expect(categories.expenses.education).toEqual(expect.arrayContaining([
    ...
    it('are subcategoriile corecte pentru cheltuieli.career', () => {
        expect(categories.expenses.career).toEqual(expect.arrayContaining([
    ...
    it('are subcategoriile corecte pentru cheltuieli.health', () => {
        expect(categories.expenses.health).toEqual(expect.arrayContaining([
    ...
    it('are subcategoriile corecte pentru cheltuieli.nutrition', () => {
        expect(categories.expenses.nutrition).toEqual(expect.arrayContaining([
    ...
    it('are subcategoriile corecte pentru cheltuieli.housing', () => {
        expect(categories.expenses.housing).toEqual(expect.arrayContaining([
    ...
    it('are subcategoriile corecte pentru cheltuieli.leisure', () => {
        expect(categories.expenses.leisure).toEqual(expect.arrayContaining([
    ...
    it('are subcategoriile corecte pentru cheltuieli.travel', () => {
        expect(categories.expenses.travel).toEqual(expect.arrayContaining([
    ...
    it('are subcategoriile corecte pentru cheltuieli.transport', () => {
        expect(categories.expenses.transport).toEqual(expect.arrayContaining([
    ...
    it('are subcategoriile corecte pentru cheltuieli.investments', () => {
        expect(categories.expenses.investments).toEqual(expect.arrayContaining([
