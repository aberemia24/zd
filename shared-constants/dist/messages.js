...
export const MESAJE = {
    ...
    CATEGORII: {
        ...
        EROARE_REDENUMIRE: 'Eroare la redenumirea subcategoriei',
        DOAR_CUSTOM_STERGERE: 'Doar subcategoriile custom pot fi șterse',
        EROARE_STERGERE_SUBCATEGORIE: 'Eroare la ștergerea subcategoriei',
        EROARE_STERGERE_ORFANE: 'Eroare la ștergerea tranzacțiilor orfane',
