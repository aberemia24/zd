  ...
  devtools(
    (set, get) => {
      ...
      return {
        ...
        setQueryParams: (params: Partial<TransactionQueryParamsWithRecurring>) => {
...
export const useTransactionQueryParams = () => useTransactionStore(state => state.currentQueryParams);
export const useTransactionUIState = () => useTransactionStore(state => ({
