...
export const supabase: SupabaseClient = {
  ...
  auth: {
    getUser: jest.fn().mockResolvedValue({ data: { user: { id: 'mock-user-id', email: 'mock@mock.com' } }, error: null }),
    getSession: jest.fn().mockResolvedValue({ data: { session: { user: { id: 'mock-user-id', email: 'mock@mock.com' } } }, error: null }),
    signInWithPassword: jest.fn().mockResolvedValue({ data: { user: { id: 'mock-user-id', email: 'mock@mock.com' }, session: {} }, error: null }),
    signUp: jest.fn().mockResolvedValue({ data: { user: { id: 'mock-user-id', email: 'mock@mock.com' }, session: {} }, error: null }),
