...
describe("Select", () => {
  ...
  it("se randează corect cu opțiunile specificate", () => {
    ...
    expect(
      screen.getByText(TEST_CONSTANTS.SELECT.OPTION_1),
    ).toBeInTheDocument();
    expect(
      screen.getByText(TEST_CONSTANTS.SELECT.OPTION_2),
    ).toBeInTheDocument();
    expect(
      screen.getByText(TEST_CONSTANTS.SELECT.OPTION_3),
    ).toBeInTheDocument();
  });
  ...
  it("afișează placeholderul corect", () => {
    render(
      <Select
        ...
        value=""
        onChange={() => {}}
        placeholder={TEST_CONSTANTS.SELECT.PLACEHOLDER}
      />,
    );
    expect(
      screen.getByText(TEST_CONSTANTS.SELECT.PLACEHOLDER),
    ).toBeInTheDocument();
  });
  ...
  it("afișează label-ul corect", () => {
    render(
      <Select
        ...
        value=""
        onChange={() => {}}
        label={TEST_CONSTANTS.SELECT.LABEL}
      />,
    );
  ...
  it("afișează mesajul de eroare", () => {
    render(
      <Select
        ...
        value=""
        onChange={() => {}}
        error={TEST_CONSTANTS.SELECT.REQUIRED_ERROR}
      />,
    );
    expect(
      screen.getByText(TEST_CONSTANTS.SELECT.REQUIRED_ERROR),
    ).toBeInTheDocument();
  });
  ...
  it("funcționează corect când există eroare", () => {
    ...
    expect(
      screen.getByText(TEST_CONSTANTS.COMMON.ERROR_GENERIC),
    ).toBeInTheDocument();
  });
