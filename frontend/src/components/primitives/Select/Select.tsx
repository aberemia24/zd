...
export interface SelectProps extends Omit<React.SelectHTMLAttributes<HTMLSelectElement>, 'size' | 'data-testid'>, CVASelectProps {
    ...
    <div className={cn(
      ...
      <div className="relative">
        <select
          ...
          data-testid={dataTestId || `select-${selectVariant}-${size}${error ? '-error' : ''}${disabled ? '-disabled' : ''}`}
