...
export const LunarGridTransition: React.FC<LunarGridTransitionProps> = ({
  ...
  const handleCellSave = useCallback(async (data: LunarGridCellData) => {
      ...
      >
        <div className="mb-4 p-4 bg-blue-50 border border-blue-200 rounded-lg">
          ...
          <p className="text-xs text-blue-600">
            Modalurile au fost înlocuite cu inline editing. 
            Folosiți F2 pentru editare, Enter pentru salvare, Escape pentru anulare.
          </p>
          <div className="mt-2 text-xs text-blue-500">
            Performance: {shouldOptimize ? 'Optimized' : 'Standard'} | 
            Focus: Row {focusedCell.row}, Col {focusedCell.col}
          </div>
        </div>
    ...
    <div data-testid="lunar-grid-legacy">
      <div className="mb-4 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
        ...
        <p className="text-xs text-yellow-600">
          Folosind modalurile existente. Activați inline editing pentru experiența nouă.
        </p>
      </div>
