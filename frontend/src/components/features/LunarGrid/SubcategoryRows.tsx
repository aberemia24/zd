...
export interface SubcategoryRowsProps {
  categoryKey: string;
  subcats: Record<string, readonly string[]>;
...
export const SubcategoryRows: React.FC<SubcategoryRowsProps> = ({
  ...
  return (
    <>
      {Object.values(subcats).flatMap((list: readonly string[]) =>
        list.map((subcat) => (
          <tr
              ...
              {user && isCustomSubcategory(categoryKey, subcat) && (
                <div className="flex gap-2 ml-auto">
                  <button
                    ...
                    onClick={(e) => { e.stopPropagation(); handleEditSubcategory(categoryKey, subcat, 'edit'); }}
                    title="Edit"
                  ...
                  <button
                    ...
                    onClick={(e) => { e.stopPropagation(); handleEditSubcategory(categoryKey, subcat, 'delete'); }}
                    title="Delete"
