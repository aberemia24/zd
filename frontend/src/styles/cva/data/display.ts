...
export const dataTable = cva("min-w-full divide-y divide-gray-200", {
  variants: {
    variant: {
      default: "",
      striped: "[&>tbody>*:nth-child(odd)]:bg-gray-50",
      bordered:
        "border-collapse border border-gray-200 [&>*>tr>*]:border [&>*>tr>*]:border-gray-200",
...
export const tableRow = cva(["transition-colors duration-150"], {
  variants: {
    variant: {
...
export const categoryContainer = cva(
  ["relative w-full rounded-lg", "transition-shadow duration-150"],
  {
    variants: {
      variant: {
...
export const categoryList = cva("divide-y divide-gray-100", {
  variants: {
    variant: {
...
export const categoryItem = cva(
  ["p-4 flex items-center justify-between", "transition-colors duration-150"],
  {
    variants: {
      variant: {
...
export const categoryHeader = cva("font-medium mb-4", {
  variants: {
    variant: {
      default: "text-lg text-gray-800",
      accent: "text-lg text-blue-700",
      section:
        "text-lg font-semibold text-blue-700 border-b border-gray-200 pb-2",
    },
  },
  defaultVariants: {
    variant: "default",
...
export const categoryBadge = cva(
  ["ml-2 text-xs rounded-full px-2 py-1", "transition-colors duration-150"],
  {
    variants: {
      variant: {
...
export const categoryAddForm = cva("mt-4 flex items-center gap-2", {
  variants: {
    variant: {
...
export const categoryDialog = cva(
  ["p-4 bg-white rounded-lg shadow-lg", "transition-all duration-150"],
  {
    variants: {
      variant: {
        default: "",
...
export const modalTitle = cva("font-bold text-blue-700", {
  variants: {
    size: {
      default: "text-xl",
      large: "text-2xl",
...
export const modalCloseButton = cva(
  ["text-2xl transition-colors duration-150", "hover:text-red-600"],
  {
    variants: {
      variant: {
        default: "",
...
export const modalBody = cva("bg-white", {
  variants: {
    padding: {
      default: "p-6",
      large: "p-8",
...
export const flexGroup = cva("flex", {
  variants: {
    justify: {
...
export type CategoryActionButtonProps = VariantProps<
  typeof categoryActionButton
>;
