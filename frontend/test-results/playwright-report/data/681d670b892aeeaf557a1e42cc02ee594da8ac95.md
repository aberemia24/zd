...
- Name: LunarGrid - Flux Simplu E2E >> fluxul complet: login → expand → adaugă subcategorie → redenumește → adaugă tranzacții → șterge → schimbă luna
- Location: C:\windsurf repo\budget-app\frontend\tests\e2e\suites\features\lunargrid-simple-flow.spec.ts:23:7
...
Call log:
  ...
  - waiting for getByTestId('lunar-grid-container')
    ...
    at C:\windsurf repo\budget-app\frontend\tests\e2e\suites\features\lunargrid-simple-flow.spec.ts:36:5
```
